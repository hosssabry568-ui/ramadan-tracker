        ...
        <DialogContent className='sm:max-w-md' dir={isRtl ? 'rtl' : 'ltr'}>
          ...
          <div className='grid grid-cols-5 gap-3'>
            {socials.map((social) => (
              <a
                ...
                className={`${social.color} text-white rounded-xl p-3 flex flex-col items-center gap-1.5 transition-all hover:scale-105 hover:shadow-lg`}
              >
                {social.icon}
          ...
          <div className='flex items-center gap-2 bg-gray-50 dark:bg-gray-800 rounded-lg p-2'>
            <input
              ...
              readOnly
              value={shareUrl}
              className='flex-1 bg-transparent text-sm text-gray-600 dark:text-gray-300 outline-none px-2'
            />
            <Button
              size='sm'
              variant='outline'
